...
export async function searchMemory(cfg, payload) {
  ...
  // Time decay: final_score = similarity × 1/(1 + α × ln(1 + days_old))
  // When α = 0, no decay (decay factor = 1.0 always)
  // We fetch more results than needed (3x), apply decay, filter by threshold, then limit
